...
{
    NSString *upAction;
    NSString *username = @"0c30d001-28bc-4418-b87b-a3daca2f57be";
    NSString *psd = @"esEbdbOHqGrIQhggZHviJdREOGjxMw";
...
-(void) doASIHttpWithData:(NSMutableData*)postData
{
    ...
    if (!error) {
        ...
        [self XMLzhunJsonWithXML:self.result];
...
-(void)XMLzhunJsonWithXML:(NSString *)xmlStr
{
    // 解析XML为NSDictionary
